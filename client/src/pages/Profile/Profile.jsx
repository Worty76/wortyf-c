...
import Topic from "../Discussion/Section/Topic";
import TotalAvatars from "../../components/TotalAvatars";
    ...
    try {
      await axios
        ...
        .then((response) => {
          ...
          setUsersComments(response.data.usersComments);
        })
                      ...
                      <Container maxWidth="large">
                        <Toolbar disableGutters>
                          ...
                          <Box sx={{ flexGrow: 0 }}>
                            <ListItem>
                              <ListItemAvatar>
                                <TotalAvatars props={post.comments} />
                              </ListItemAvatar>
                            </ListItem>
                          </Box>
                        </Toolbar>
